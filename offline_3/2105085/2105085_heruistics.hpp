        ...
        for (int c = 0; c < COLS; c++)
        {
            ...
            if (col == player || cellStr == "0")
            {
                ...
                for (auto &d : adj_cells)
                {
                    ...
                    if(cellStr =="0" and nbCol!= player && nbVal >= nbCrit - 1)
                    {
                        score -= 300;
                    }
                    else if (cellStr == "0" && nbCol == player && nbVal >= nbCrit - 1)
                    {
                        score += 300;
                    }
                    if(nbCol!=player && nbVal ==nbCrit-1 and n == crit - 1)
                    {
                        score += 800;
                    }

                    else if (nbCol != player && nbVal == nbCrit - 1 && n < crit - 1)
                    {
                        score -= 100;
                    }
